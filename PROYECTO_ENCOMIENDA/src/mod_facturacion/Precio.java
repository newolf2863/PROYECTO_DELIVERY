...
/**
 * Representa el cálculo del precio total de un paquete, considerando distintos
 * tipos de cálculos de precios.
...
public class Precio implements Serializable {
     ...
     * @param precioPorDefecto   el cálculo de precio por defecto que se aplicará al
     *                           paquete.
     * @param preciosAdicionales cálculos de precios adicionales que se aplicarán al
     *                           paquete.
     */
    ...
    /**
     * Obtiene una lista de todos los cálculos de precios individuales utilizados
     * para calcular el precio total.
     *
     * @return una lista de objetos {@link CalculoPrecio} que representan los
     *         cálculos de precios individuales.
     */
